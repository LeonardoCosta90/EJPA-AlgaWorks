...
public class OperacoesComTransacaoTest extends EntityManagerTest {
    ...
    public void mostrarDiferencaPersistMerge(){
        ...
        produtoPersist.setNome("Notebook Dell");
        produtoPersist.setDescricao("O melhor da categoria");
...
//        entityManager.clear(); //Não é necessario na ação de remoção
...
//        Produto produto = new Produto(); // Somente para os métodos não mostrar erros
